...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/HoloExcept
   # Navigate to the newly cloned directory
   cd HoloExcept
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/Orwel/HoloExcept
   ```
...
4. Make your change. Add tests for your change. Make the tests pass:
    ...
    dotnet test .\src\Holo.Except.Test\
